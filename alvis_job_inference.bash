...
#SBATCH -t 7-00:00:00
#SBATCH --output=test_CorrDiff.out

#export TORCH_NCCL_HEARTBEAT_TIMEOUT_SEC=1200
export HDF5_USE_FILE_LOCKING=FALSE

RUN_NAME="--wandb_run_name test_CorrDiff"

# Switch to the correct directory
cd /mimer/NOBACKUP/groups/mlhighres/users/mikhaili/neural-lam

output_path="output/230126/test_CorrDiff"
ensemble_size=20 # 5 - val, 20 - test
sampler_steps=20 # 50 - SI, 20 - CorrDiff
sampler="edm" # euler - SI, edm - CorrDiff
batch_size=8
n_workers=8
diffusion_model="edm" # song_unet - SI, edm - CorrDiff
