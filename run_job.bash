#!/bin/bash
#SBATCH -J cosine_graph_fm_border_condition_400e
#SBATCH -t 3-00:00:00
...
RUN_NAME="--wandb_run_name cosine_graph_fm_border_condition_400e"
...
python3 neural_lam/train_model.py "--model" $MODEL $DIFFUSION_MODEL "--n_workers" 16 $RUN_NAME --batch_size 4 --val_interval 10 --pred_residual --border_condition --lr 0.00001 --epochs 400 --load $BORDER_GRAPH_FM_300e --lr_scheduler cosine #   # --eval test --sampler heun # --plot_diffusion_steps
