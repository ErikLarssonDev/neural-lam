#!/bin/bash
#SBATCH -J start_graph_fm_border_condition_200e
#SBATCH -t 3-00:00:00
...
RUN_NAME="--wandb_run_name start_graph_fm_border_condition_200e"
...
python3 neural_lam/train_model.py "--model" $MODEL $DIFFUSION_MODEL "--n_workers" 16 $RUN_NAME --batch_size 4 --val_interval 10 --pred_residual --border_condition # --eval test --subset_ds  # --lr 0.0001 --epochs 300 #   # --eval test --sampler heun # --plot_diffusion_steps
