...
RUN_NAME="--wandb_run_name EDM_full_8"
...
# Train
python3 neural_lam/train_model.py --model diffusion --diffusion_model edm $RUN_NAME  --n_workers 16 --pred_residual --border_condition --epochs 600 --batch_size 12 --val_interval 10 # --lr 0.000001 # --load $EDM_1800e  # --encoder_type residual # --noise_aug_prob 0.5
...
# python3 neural_lam/train_model.py --model diffusion --diffusion_model edm --n_workers 2 --pred_residual --border_condition --eval test --n_example_pred 1 --batch_size 1 --subset_ds --ensemble_size 1 --sampler heun --load /proj/berzelius-2022-164/users/x_erila/neural-lam/saved_models/EDM_1200e-diffusion-6x128-01_14_08-9197/last.ckpt --sampler_steps 1
