#!/bin/bash
#SBATCH -J 40_BORDER_GRAPH_FM_400e
#SBATCH -t 3-00:00:00
...
RUN_NAME="--wandb_run_name 40_BORDER_GRAPH_FM_400e"
...
python3 neural_lam/train_model.py "--model" $MODEL $DIFFUSION_MODEL "--n_workers" 16 $RUN_NAME --batch_size 4 --val_interval 10 --pred_residual --border_condition --load $BORDER_GRAPH_FM_400e --eval test # --subset_ds # --lr 0.00001 --epochs 400 --load $BORDER_GRAPH_FM_300e --lr_scheduler cosine #   # --eval test --sampler heun # --plot_diffusion_steps
