#!/bin/bash
#SBATCH -J graph_fm_sigmamin_0.0002
#SBATCH -t 3-00:00:00
...
RUN_NAME="--wandb_run_name graph_fm_sigmamin_0.0002"
...
python3 train_model.py "--model" $MODEL $DIFFUSION_MODEL "--n_workers" 16 $RUN_NAME --batch_size 4 --val_interval 10 --pred_residual # --load $NORM_LOSS_RES_GRAPH_FM --eval test --subset_ds 1 --sampler heun --plot_diffusion_steps  # --border_condition
