...
class SongUNet(torch.nn.Module):
    def __init__(self,
        ...
        self.grid_embedder = nn.Conv2d(in_channels=in_channels, out_channels=model_channels, kernel_size=1) # To go from 17 to 128 channels
...
if __name__=='__main__':
    ...
    model = EDMPrecond(img_resolution=torch.tensor([268, 238]), in_channels=17*2, out_channels=17, model_type='SongUNet', resample_filter=[1, 1], channel_mult=[1,2,2,2], encoder_type='standard').to(device)
    # print(model)
