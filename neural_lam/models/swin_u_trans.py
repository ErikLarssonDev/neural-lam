...
class SwinUTrans(ARModel):
    ...
    def __init__(self, args):
        ...
        self.model =  SwinTransformerSys(img_size=(268, 238), in_chans=self.input_dim, num_classes=self.output_dim)
...
def window_partition(x, window_size):
    ...
    """
    B, H, W, C = x.shape
    print("x.shape", x.shape) # x.shape torch.Size([1, 67, 59, 1])
    print("window_size", window_size) # window_size 7

    # Expected size: [1, 9, 7, 8, 7, 1]
