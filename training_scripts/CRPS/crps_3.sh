...
# Standard arguments
RUN_NAME="--wandb_run_name CRPS_AR2_1200e"
...
python3 neural_lam/train_model.py --model CRPS $RUN_NAME  --n_workers 16 --pred_residual --border_condition --epochs 1200 --batch_size 1 --lr 0.00001 --ar_steps 2 --load $CHECKPOINT