...
RUN_NAME="--wandb_run_name UNET_xsmall_25e"
...
# python3 neural_lam/train_model.py --model unet $RUN_NAME --data_config $DATA_CONFIG --n_workers 16 --batch_size 10 --epochs 50 --lr 0.00001 --val_interval 5 --load $UNET_50e --restore_opt --eval val # --subset_ds

python3 neural_lam/train_model.py --model unet $RUN_NAME --n_workers 16 --batch_size 10 --epochs 25 --lr 0.00001 --val_interval 10 --eval val --load $UNET_xsmall_25e
