...
# UNET
# Train
python3 neural_lam/train_model.py --model unet --n_workers 16 --batch_size 2 --epochs 50 --lr 0.00001

# Eval
# python3 neural_lam/train_model.py --model unet --n_workers 16 --batch_size 2 --epochs 50 --lr 0.00001 --eval test --n_example_pred 1 --load 
