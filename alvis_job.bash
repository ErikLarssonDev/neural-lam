...
RUN_NAME="--wandb_run_name CorrDiff_SEED"
...
# EDM
# Training
# python3 neural_lam/train_model.py --model diffusion --diffusion_model edm $RUN_NAME  --n_workers 16 --batch_size 2 --epochs 50 --lr 0.00001 --val_interval 10 # --load $EDM_50e_stand
...
# SI
# Training
# python3 neural_lam/train_model.py --model SI --diffusion_model song_unet $RUN_NAME  --n_workers 16 --batch_size 2 --epochs 50 --lr 0.00001 --sampler euler --sampler_steps 50 --val_interval 10 # --load $SI_25e
