#!/bin/bash
#SBATCH -J sampler_50_IR_SDE_neural_lam_200e
#SBATCH -t 0-05:00:00
#SBATCH --gpus=8
#SBATCH -C "fat"
...
RUN_NAME="--wandb_run_name sampler_50_IR_SDE_neural_lam_200e"

# Paths to saved models

# Execute Python script with arguments
# Train
python3 neural_lam/train_model.py --model ir_sde --diffusion_model song_unet $RUN_NAME  --n_workers 16 --batch_size 12 --epochs 200  --sampler_steps 50 # --load $IR_SDE_600e
